    ...
    public static class Metric
    {
        ...
        private static string GetGlobalContextName()
        {
            try
            {
                ...
                var contextNameValue = Environment.GetEnvironmentVariable(contextNameKey) ?? Configuration.AppSettings[contextNameKey];
        ...
        private static string ReplaceRemainingTokens(string configName)
        {
            ...
            foreach (var match in matches.Cast<Match>())
            {
                ...
                if (string.IsNullOrWhiteSpace(val))
                {
                    ...
                    val = Configuration.AppSettings[key.Value];
                    if (string.IsNullOrWhiteSpace(val))
                    {
